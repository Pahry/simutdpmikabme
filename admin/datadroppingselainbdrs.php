    ...
    <section class="content">
      ...
      <div class="container-fluid">
        ...
        <div class="card">
              ...
              <tbody>
                <?php $no=1; foreach ($tampil as $tpl): ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-warning btn-sm" href="detaildroppingselainbdrs.php?id=<?= $tpl['iddropping']?>" title="Detail"><i class="far fa-eye"></i></a>
                      <a class="btn btn-primary btn-sm" href="ubahdroppingselainbdrs.php?id=<?=$tpl['iddropping'];?>" title="Ubah"><i class="fas fa-edit"></i></a>
                      <a class="btn btn-danger btn-sm" href="hapusdroppingselainbdrs.php?id=<?=$tpl['iddropping'];?>" title="Hapus" onclick="return confirm('Apakah Anda Yakin ?')"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
          ...
          <a href="cetakdroppingselainbdrs.php" class="btn btn-info mt-3" target="_blank"><i class="fas fa-print"></i> Cetak</a>
