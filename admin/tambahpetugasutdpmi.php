...
if (isset($_POST['submit'])) {
  ...
  $namapetugasutdpmi  = $_POST['namapetugasutdpmi'];
    ...
    <section class="content">
      ...
      <form action="" method="POST">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="namapetugasutdpmi" name="namapetugasutdpmi" placeholder="Masukkan Nama Lengkap">
        </div>
        <div class="form-group">
