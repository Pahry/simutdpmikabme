<?php 
  ...
  $bdrs     = tampildroppingbdrs("SELECT * FROM droppingbdrs  WHERE iddroppingbdrs = $id")[0];


  if (isset($_POST['submit'])) 
  {
      if(ubahdroppingbdrs($_POST) > 0)
      {
        echo  "<script>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah Data Dropping Darah BDRS</h1>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <form action="" method="POST">
        ...
        <input type="hidden" name="id" value="<?php echo $bdrs['iddroppingbdrs']; ?>">

        <div class="form-group row">
          <label for="tanggaldropping" class="col-sm-2 col-form-label">Tanggal Dropping</label>
          <div class="col-sm-8">
            <input type="date" class="form-control" name="tanggaldropping" id="tanggaldropping" value="<?php echo $bdrs['tanggaldropping'] ?>">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" name="nomorberitaacara" class="form-control" id="nomorberitaacara" value="<?php echo $bdrs['nomorberitaacara']; ?>" readonly>
          </div>
        </div>
          ...
          <div class="col-sm-8">
            <select class="form-control" id="idpasien" name="idpasien" required>
              <?php foreach ($pasien as $psn): ?>
                <option value="<?php echo $psn['idpasien']; ?>" <?php if($bdrs['idpasien']==$psn['idpasien']) echo "selected"; ?>>
                  <?php echo $psn['kodepasien']; ?></option>
              <?php endforeach ?>
            </select>
          </div>
        </div>
          ...
          <div class="col-sm-8">
            <select class="form-control" id="idpendonor" name="idpendonor" required>
              <?php foreach ($pendonor as $dnr): ?>
                <option value="<?php echo $dnr['idpendonor']; ?>" <?php if($bdrs['idpendonor']==$dnr['idpendonor']) echo "selected"; ?>>
                  <?php echo $dnr['nomorkantongpendonor']; ?>
                </option>
              <?php endforeach ?>
            </select>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" name="namapenerima" id="namapenerima" value="<?php echo $bdrs['namapenerima'] ?>">
          </div>
        </div>
          ...
          <div class="col-sm-8">
            <select class="form-control" id="idpetugas" name="idpetugas">
              <?php foreach ($petugas as $ptgs): ?>
                  <option value="<?php echo $ptgs['idpetugasutdpmi'] ?>" <?php if($bdrs['idpetugas']==$ptgs['idpetugasutdpmi']) echo "selected"; ?>>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" name="alamat" id="alamat" value="<?php echo $bdrs['alamat'] ?>" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" name="volumekantongdarah" id="volumekantongdarah" name="volumekantongdarah" class="form-control" value="<?php echo $bdrs['volumekantongdarah'] ?>" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="date" class="form-control" id="tanggalpenyadapan" name="tanggalpenyadapan" value="<?php echo $bdrs['tanggalpenyadapan'] ?>" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="date" class="form-control" id="tanggalexpired" name="tanggalexpired" value="<?php echo $bdrs['tanggalexpired'] ?>" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <select class="form-control" id="jeniskolf" name="jeniskolf" required>
              <option value="Single" <?php if($bdrs['jeniskolf']=='Single') echo "selected"; ?>>Single</option>
              <option value="Double" <?php if($bdrs['jeniskolf']=='Double') echo "selected"; ?>>Double</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text-area" name="keterangan" class="form-control" id="keterangan" value="<?php echo $bdrs['keterangan'] ?>">
          </div>
        </div>
