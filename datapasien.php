          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Tanggal Permintaan Darah</th>
                  <th>Nama Pasien</th>
                  <th>Rumah Sakit</th>
                ...
                <?php $no=1; foreach($tampilpasien as $tpl) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-primary" href="ubahpasien.php?id=<?= $tpl['idpasien'];?>"><i class="fas fa-edit"></i> Ubah</a>
                      <a class="btn btn-danger" href="hapuspasien.php?id=<?= $tpl['idpasien'];?>" onclick="return confirm('Apakah Anda Yakin ?')"><i class="fas fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
