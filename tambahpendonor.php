  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Pendonor</h1>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <form method="post" action="">
        ...
        <div class="form-group row">
          <label for="tempatdonordarah" class="col-sm-2 col-form-label">Tempat Donor Darah</label>
          <div class="col-sm-8">
        ...
        <div class="form-group row">
          <label for="donorke" class="col-sm-2 col-form-label">Donor Ke</label>
          <div class="col-sm-8">
