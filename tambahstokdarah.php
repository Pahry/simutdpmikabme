  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Stok Darah</h1>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="number" name="a" id="a" class="form-control" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="number" name="b" id="b" class="form-control" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="number" name="ab" id="ab" class="form-control" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="number" name="o" id="o" class="form-control" required>
          </div>
        </div>
